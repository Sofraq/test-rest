...
const povertyScenarios: Record<number, { title: string; archetype: string; growthZone: string; description: string; manifestation: string; barrier: string; risks: string }> = {
  1: {
    title: "Архетип «Абсолютный Лидер»",
    archetype: "(вместо \"Я сама\")",
  ...
  2: {
    ...
    archetype: "(вместо \"Удобная женщина\")",
  ...
  3: {
    ...
    archetype: "(вместо \"Кастрирующая Императрица\")",
  ...
  6: {
    ...
    archetype: "(вместо \"Разочарованная Принцесса\")",
  ...
  8: {
    ...
    archetype: "(вместо \"Воин Справедливости\")",
  ...
  9: {
    ...
    archetype: "(вместо \"Спасатель Мира\")",
          ...
          {result !== null && (
            <div className="animate-fade-in-up">
              ...
              <div className="bg-secondary/30 border border-primary/20 rounded-lg p-6 md:p-8">
                ...
                <p className="text-muted-foreground/70 text-sm mb-6 ml-9">
                  {povertyScenarios[result].archetype}
                </p>
